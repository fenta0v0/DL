...
while data_count<data_number
    ...
    %初始化参数
        ...
        particle_number = 100; % 模拟的粒子个数
        sidex = Nx * pixel_size;  % CCD 尺寸
        sidey = Ny * pixel_size;
        pattern = zeros(Nx, Ny); % 初始图像为全0
        particle_size = randi([2,5], 1, particle_number); % 模拟粒子半径的大小，list[1,num]
...
生成全息图
        ...
        %imshow(I_new);
        filename=['E:\datasets\speed_test\train\data\1st\',num2str(data_count+1),'.png'];
...
生成label
        ...
        filename_x=['E:\datasets\speed_test\train\text\1st/x_',num2str(data_count+1),'.txt'];
        filename_y=['E:\datasets\speed_test\train\text\1st/y_',num2str(data_count+1),'.txt'];
        filename_r=['E:\datasets\speed_test\train\text\1st/r_',num2str(data_count+1),'.txt'];
        filename_d=['E:\datasets\speed_test\train\text\1st/z_',num2str(data_count+1),'.txt'];
        ...
        figure(2)
        %imshow(I_new_1);
        filename_1=['E:\datasets\speed_test\train\label\1st\',num2str(data_count+1),'.png'];
...
第二帧image
    ...
    %     noisy_hologram=hologram+max(max(hologram))/100*rand(Nx,Ny);  %加噪声
        I_new=mat2gray(hologram)
        filename=['E:\datasets\speed_test\train\data\2nd\',num2str(data_count+1),'.png'];
        imwrite(I_new,filename,'png');
...
第二帧label
        ...
        filename_x=['E:\datasets\speed_test\train\text\2nd/x_',num2str(data_count+1),'.txt'];
        filename_y=['E:\datasets\speed_test\train\text\2nd/y_',num2str(data_count+1),'.txt'];
        filename_r=['E:\datasets\speed_test\train\text\2nd/r_',num2str(data_count+1),'.txt'];
        filename_d=['E:\datasets\speed_test\train\text\2nd/z_',num2str(data_count+1),'.txt'];
    ...
    %     figure(2)
        %imshow(I_new_1);
        filename_1=['E:\datasets\speed_test\train\label\2nd\',num2str(data_count+1),'.png'];
...
U 、V、W
        ...
        filename_1=['E:\datasets\speed_test\train\label\uv\',num2str(data_count+1),'.png'];
    ...
    %     figure(2)
        ...
        filename_1=['E:\datasets\speed_test\train\label\uw\',num2str(data_count+1),'.png'];
        imwrite(I_new_4,filename_1,'png');
        
        filename_u = ['E:\datasets\speed_test\train\text\uvw/u_',num2str(data_count+1),'.txt'];
        filename_v = ['E:\datasets\speed_test\train\text\uvw/v_',num2str(data_count+1),'.txt'];
        filename_w = ['E:\datasets\speed_test\train\text\uvw/w_',num2str(data_count+1),'.txt'];
