...
working_dist=100;   %microns
depth_factor=1;%2^11/zmax; % scaling, now range is set as 2.048cm,2^11microns 8um


generation hologram and corresponding ground true
data_cale = 8000;%datasets numbers  # 数据总数
data_count = 0;
...
%     I_new=mat2gray(noisy_hologram);
    figure(8)
    %imshow(I_new);
    filename=['D:\desktop\data_test1\not sick\data\',num2str(data_count+1),'.png'];
...
Generate ground true
    ...
    filename_x=['D:\desktop\data_test1\not sick/text/x_',num2str(data_count+1),'.txt'];
    filename_y=['D:\desktop\data_test1\not sick\text/y_',num2str(data_count+1),'.txt'];
    filename_r=['D:\desktop\data_test1\not sick\text/r_',num2str(data_count+1),'.txt'];
    filename_d=['D:\desktop\data_test1\not sick\text/z_',num2str(data_count+1),'.txt'];
    ...
    figure(2)
    %imshow(I_new_1);
    filename_1=['D:\desktop\data_test1\not sick\label\',num2str(data_count+1),'.png'];
